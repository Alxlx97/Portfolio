    ...
    function ContactLink({ label, value, href }) {
        return(
            <a href={href} target={href.startsWith('mailto') ? undefined : '_blank'} rel="noreferrer"
               className="group flex items-center justify-between py-5 border-b border-[#2a2a2a] text-[#a8a59d] hover:text-[#e8e6e0]
    ...
    return(
        <section id="contact" className="px-12 py-28 border-t border-[#2a2a2a] bg-[#0a0a0a]">
            <div className="max-w-2xl">
                ...
                <p ref={labelRef} className="fade-up font-mono-custom text-[0.65rem] tracking-[.2em] uppercase text-[#a8a59d] mb-12 flex items-center gap-3">
                    <span>Contact</span>
                </p>

                <h2 ref={titleRef} className="fade-up font-serif text-[clam(2em,2vw,3.5rem)] leading-tight tracking-light mb-6">
                    Travaillons <br /> <em className="text-[#a8a59d]">ensemble.</em>
                </h2>

                <p className="text-[#a8a59d] text-base leading-relaxed mb-10 font-light">
